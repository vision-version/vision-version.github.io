...
def plot_cg(graph_data, cveid, status, RUNPATH, jarVersion):
    ...
    plt.savefig(os.path.join(RUNPATH, f'jar_file/CGs/{cveid}/{cveid}_{jarVersion}_{status}_graph_image.png'))
    plt.close()
