...
if __name__ == "__main__":
    ...
    for i in range(0, 11):
        print(i)
        cve_num, prefect_cve, tp_lib_all, fp_lib_all, tn_lib_all, fn_lib_all, precision, recall, f1 = eval_ourtool(f"../trueresult.json", f"sortresults_vulnerable_{i}.json")
        threshold_result[i] = {
            "precision": precision,
            "recall": recall,
            "f1-score": f1
        }
    with open("vul_threshold.json", "w") as fw:
